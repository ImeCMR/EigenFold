...
def parse_train_args():
    ...
    # NMR args
    parser.add_argument('--nmr_loss_weight', type=float, default=0.1, help='Weight for the NMR distance constraint loss')
    parser.add_argument('--nmr_huber_delta', type=float, default=1.0, help='Delta for the Huber loss on NMR constraints')
    parser.add_argument('--nmr_dist_embed_dim', type=int, default=32, help='Dimension of NMR distance embedding')
